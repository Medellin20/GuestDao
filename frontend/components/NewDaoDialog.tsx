    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[90vh] overflow-y-auto mx-2 sm:mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Authority Input with Suggestions */}
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              />
              {formData.autoriteContractante.length > 0 && (
                <div className="absolute top-full left-0 right-0 bg-white border border-border rounded-md shadow-lg z-10 max-h-40 overflow-y-auto">
                  {SAMPLE_AUTHORITIES.filter((authority) =>
                    authority
                      .toLowerCase()
                      .includes(formData.autoriteContractante.toLowerCase()),
                  )
                    .slice(0, 5)
                    .map((authority) => (
                      <button
